    ...
    while True:
        ...
        if turn_side == 0 or turn_side == 2:
            ...
            if color_y_positions[2] < color_y_positions[3]:
                ...
                if color_y_positions[2] != 0:
                    a = (70 - 35) / (480 - 60)
                    b = 70 - a * 480
                    PWM = a * color_y_positions[2] + b
                else:
                    PWM = 70
            elif pink_positions[1] != 0:
                if target_heading == left_heading or target_heading == red_right_heading: 
                    combined_control_signal = -pd_control(0, pink_green_x_diff, kp_X, kd_X)
                elif target_heading == right_heading or target_heading == red_left_heading: 
                    combined_control_signal = pd_control(0, pink_red_x_diff, kp_X, kd_X)
                if pink_positions[1] != 0:
                    a = (70 - 35) / (480 - 60)
                    b = 70 - a * 480
                    PWM = a * pink_positions[1] + b
                else:
                    PWM = 70
