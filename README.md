...
- The inspiration for the hardware and software design of this autonomous vehicle came from the model designed by our seniors last year, and we also drew on the strengths of the model that won first place in last year’s competition. Based on this, we made improvements to enhance performance and innovative design, aiming to make it more competitive.
